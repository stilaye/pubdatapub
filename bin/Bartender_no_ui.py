...
order_countries=['BRA','PER','ECU','CHL','BOL','COL','VEN',]
global order_years
order_years=['2000','2005','2010','2011','2012','2013']
global indic_name
indic_name=['Internet users','IHDI: Inequality-adjusted income index','Middle Class ($10-50 a day) Headcount','Poverty Headcount ($1.25 a day)','Poverty Headcount ($2.50 a day)']
'''now file type as glass, name as name. save_dir is the directory, currently using whatever directory you are running this code from'''
global glass
glass='csv'
global save_dir
save_dir=os.getcwd()
